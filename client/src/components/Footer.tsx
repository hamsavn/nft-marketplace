...
export const Footer = () => (
  <div className="greyscheme" style={{ minHeight: 'auto' }}>
    <footer className="footer-light" style={{ padding: 0 }}>
        ...
        <div className="row">
          ...
          {/* <div className="col-md-3 col-sm-6 col-xs-1">
            <div className="widget">
              ...
              <small>Your email is safe with us. We don&lsquo;t spam.</small>
            </div>
          </div> */}
        </div>
      </div>
      <div className="subfooter" style={{ marginTop: 0, borderTop: 0 }}>
        <div className="container">
          <div className="row">
              ...
              <div className="de-flex">
                <div className="de-flex-col">
                  <span onClick={() => window.open('', '_self')}>
                    ...
                    <span className="copy">&copy; Copyright 2022 - Hamsa</span>
                  </span>
                </div>
                <div className="de-flex-col">
