...
import { NftStats } from '@generated/graphql';
...
const slidermainparticle: React.FC<Props> = ({ stats }) => (
      ...
      <div className="col-md-6">
        ...
        <Reveal className="onStep" keyframes={fadeInUp} delay={600} duration={900} triggerOnce>
          <p className="lead col-white">
            Unit of data stored on a digital ledger, called a blockchain, that certifies a digital
            ...
            <div className="row">
              <div className="col-lg-4 col-md-6 col-sm-4 mb30">
                <div className="de_count text-left">
                  ...
                  <h5 className="id-color">Artworks</h5>
                </div>
              </div>
              {/* 
              <div className="col-lg-4 col-md-6 col-sm-4 mb30">
